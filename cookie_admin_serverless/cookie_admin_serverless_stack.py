    ...
    def __init__(self, scope: Construct, construct_id: str, environment_tag: str, **kwargs) -> None:
        ...
        cookie_handler = _lambda.Function(self, "CookieHandler",
            ...
            environment={
                ...
                "ALLOWED_ORIGIN": allowed_origin # <--- Injeção Importante
            },
        ...
        # Nota: Idealmente adicionaríamos rotas para /orders e /logistics aqui também, ou usar ANY /{proxy+}
        ...
        CfnOutput(self, "SiteBucketName", value=site_bucket.bucket_name) # Correção: usar .bucket_name, não a url